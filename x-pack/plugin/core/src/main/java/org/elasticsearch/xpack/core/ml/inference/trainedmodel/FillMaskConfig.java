...
public class FillMaskConfig implements NlpConfig {
    ...
    public static class Builder {
        ...
        public FillMaskConfig build() throws IllegalArgumentException {
            validateMaskTokenAgainstTokenizer(maskToken);
            return new FillMaskConfig(vocabularyConfig, tokenization, numTopClasses, resultsField);
        }

        private void validateMaskTokenAgainstTokenizer(String maskToken) throws IllegalArgumentException {
            String tokenizationMaskToken = tokenization == null ? "tokenization was unexpectedly null" : tokenization.getMaskToken();

            if (maskToken != null && maskToken.equals(tokenizationMaskToken) == false) {
